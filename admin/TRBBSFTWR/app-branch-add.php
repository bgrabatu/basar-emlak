...
<head>
    ...
    <title>Şube Ekle | Başar Emlak - Yönetim Paneli </title>
...
<body class="layout-boxed">
                    ...
                    <div class="row invoice layout-top-spacing layout-spacing">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="doc-container">
                                <form action="app-branch-add.php" method="POST">
                                    <div class="row">
                                        <div class="col-xl-12">
                                                            ...
                                                            <div class="col-xl-12 invoice-address-company">
                                                                ...
                                                                <div class="invoice-address-company-fields">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="branch_owner" class="col-sm-3 col-form-label col-form-label-sm">Şube Sahibi</label>
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control form-control-sm" id="branch_owner" name="branch_owner">
                                                                        </div>
                                                                    </div>

                                                                    <div class="form-group row">
                                                                        <label for="branch_email" class="col-sm-3 col-form-label col-form-label-sm">Şube Email</label>
                                                                        <div class="col-sm-9">
                                                                            <input type="email" class="form-control form-control-sm" id="branch_email" name="branch_email">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control form-control-sm" id="branch_address" name="branch_address">
                                                                        </div>
                                                                    </div>

                                                                    <div class="form-group row">
                                                                        <label for="branch_phone" class="col-sm-3 col-form-label col-form-label-sm">Telefon Numarasi</label>
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control form-control-sm" id="branch_phone" name="branch_phone">
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div class="invoice-action-btn">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-12 col-md-4">
                                                            <button class="btn btn-success btn-download" name="branch-add">Kaydet</button>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script src="../src/assets/js/apps/branch-add.js"></script>
</body>
