...
<head>
    ...
    <title>Blog Listesi | Başar Emlak - Yönetim Paneli </title>
...
<body>
                                ...
                                <table id="invoice-list" class="table dt-table-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Blog Id</th>
                                            <th>Blog Basligi</th>
                                            <th>Blog Kisa Aciklamasi</th>
                                            <th>Blog Durumu</th>
                                            <th>Blog Yorum Durumu</th>
                                            <th>Blog Y. Tarihi</th>
                                            <th>Aksiyonlar</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        if (is_array($fetchDataBlogDetails)) {
                                            ...
                                            foreach ($fetchDataBlogDetails as $data) {
                                                ...
                                                $for_other_property_table_id = $data['blog_id'];
                                                $fetchDataBlogPhotos = fetch_data_blog_photos($db, $tableNameBlogPhotos, $columnsBlogPhotos, $for_other_property_table_id);

                                                $property_name_url = $data['blog_post_title'];
                                                $property_id_url = $data['blog_id'];
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><a href="./app-invoice-preview.php"><span class="inv-number">#<?php echo $data['blog_id'] ?></span></a></td>
                                                    <td>
                                                        <div class="d-flex">
                                                            <div class="usr-img-frame me-2 rounded-circle">
                                                                <img alt="avatar" class="img-fluid rounded-circle" src="../<?php echo $fetchDataBlogPhotos['blog_82x112'] ?>">
                                                            </div>
                                                            <p class="align-self-center mb-0 user-name"><?php echo $data['blog_post_title'] ?> </p>
                                                        </div>
                                                    </td>
                                                    <td><span class="inv-email"><?php echo $data['blog_post_short_description'] ?></span></td>
                                                    <td>
                                                        <?php
                                                        if ($data['blog_publicy'] == '1') {
                                                            echo '<span class="badge badge-light-success inv-status">Aktif</span>';
                                                        } elseif ($data['blog_publicy'] == '0') {
                                                            echo '<span class="badge badge-light-danger inv-status">Pasif</span>';
                                                        }
                                                        ?>
                                                    </td>
                                                    <td>
                                                        <?php
                                                        if ($data['blog_comment_status'] == '1') {
                                                            echo '<span class="badge badge-light-success inv-status">Aktif</span>';
                                                        } elseif ($data['blog_comment_status'] == '0') {
                                                            echo '<span class="badge badge-light-danger inv-status">Pasif</span>';
                                                        }
                                                        ?>
                                                    </td>
                                                    <td><span class="inv-date"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar">
                                                            ...
                                                            </svg> <?php echo $data['blog_date'] ?> </span></td>
                                                    <td>
                                                        <a class="badge badge-light-primary text-start me-2 action-edit" href="app-blog-edit.php?<?php echo $url ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3">
                                                                <path d="M12 20h9"></path>
                                                                <path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path>
                                                            </svg></a>
                                                        <a class="badge badge-light-danger text-start action-delete" href="app-blog-list.php?deleteBlog=<?php echo $data['blog_id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash">
    ...
    <script src="../src/assets/js/apps/blog-list.js"></script>
</body>
