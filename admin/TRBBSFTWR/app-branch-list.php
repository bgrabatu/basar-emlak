...
<head>
    ...
    <title>Şube Listesi | Başar Emlak - Yönetim Paneli </title>
...
<body>
                                    ...
                                    <tbody>
                                        ...
                                        if (is_array($fetchDataBranch)) {
                                            ...
                                            foreach ($fetchDataBranch as $data) {
                                                $branch_name_url = $data['branch_name'];
                                                $branch_id_url = $data['branch_id'];

                                                $seo_name = cleanTurkishCharacters($branch_name_url);

                                                // SEO uyumlu URL'yi oluştur
                                                $url = "/$seo_name" . "/$branch_id_url";
                                        ?>
                                                <tr>
                                                    <td class="checkbox-column"> 1 </td>
                                                    <td><a href="./app-invoice-preview.php"><span class="inv-number">#<?php echo $data['branch_id'] ?></span></a></td>
                                                    <td>
                                                        <div class="d-flex">
                                                            <p class="align-self-center mb-0 user-name"> <?php echo $data['branch_name'] ?> </p>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex">
                                                            <p class="align-self-center mb-0 user-name"> <?php echo $data['branch_owner'] ?> </p>
                                                        </div>
                                                    </td>
                                                    <td><span class="inv-email"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail">
                                                            ...
                                                            </svg> <?php echo $data['branch_email'] ?></span></td>
                                                    <td><span class="inv-email"><svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            </svg> <?php echo cleanPhoneNumber($data['branch_phone']) ?></span></td>
                                                    <td><span class="inv-email"><svg width="24px" height="24px" viewBox="0 0 1024 1024" fill="currentColor" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                                                <g id="SVGRepo_iconCarrier">
                                                            ...
                                                            </svg> <?php echo $data['branch_address'] ?></span></td>
                                                    <td>
                                                        <a class="badge badge-light-primary text-start me-2 action-edit" href="app-branch-edit.php?<?php echo $url ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3">
                                                                <path d="M12 20h9"></path>
                                                                <path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z">
                                                                </path>
                                                            </svg></a>
                                                        <a class="badge badge-light-danger text-start action-delete" href="app-branch-list.php?deleteBranch=<?php echo $data['branch_id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash">
    ...
    <script src="../src/assets/js/apps/branch-list.js"></script>
</body>
