...
<head>
    ...
    <title>Personel Listesi | Başar Emlak - Yönetim Paneli </title>
...
<body>
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12 layout-top-spacing layout-spacing">
                            <div class="widget-content widget-content-area br-8">
                                <table id="invoice-list" class="table dt-table-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th class="checkbox-column"> Personel no. </th>
                                            <th>Personel Id</th>
                                            <th>Personel Sube</th>
                                            <th>Personel Adi</th>
                                            <th>Personel Email</th>
                                            <th>Personel Telefonu</th>
                                    ...
                                    <tbody>
                                        <?php
                                        if (is_array($fetchDataPersonnel)) {
                                            $sn = 1;
                                            foreach ($fetchDataPersonnel as $data) {
                                                $personnel_name_url = $data['personnel_name'];
                                                $personnel_id_url = $data['personnel_id'];

                                                $seo_name = cleanTurkishCharacters($personnel_name_url);

                                                // SEO uyumlu URL'yi oluştur
                                                $url = "/$seo_name" . "/$personnel_id_url";
                                        ?>
                                                <tr>
                                                    <td class="checkbox-column"> 1 </td>
                                                    <td><a href="./app-invoice-preview.php"><span class="inv-number">#<?php echo $data['personnel_id'] ?></span></a></td>
                                                    <td>
                                                        <div class="d-flex">
                                                            <p class="align-self-center mb-0 user-name"> <?php echo $data['branch_id'] ?> </p>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex">
                                                            <p class="align-self-center mb-0 user-name"> <?php echo $data['personnel_name'] . " " . $data['personnel_surname'] ?> </p>
                                                        </div>
                                                    </td>
                                                    <td><span class="inv-email"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail">
                                                            ...
                                                            </svg> <?php echo $data['personnel_gmail'] ?></span></td>
                                                    <td><span class="inv-email"><svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            </svg> <?php echo cleanPhoneNumber($data['personnel_phone']) ?></span></td>
                                                    <td><span class="inv-email"><svg width="24px" height="24px" viewBox="0 0 1024 1024" fill="currentColor" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            </svg> <?php echo $data['personnel_address'] ?></span></td>
                                                    <td>
                                                        <a class="badge badge-light-primary text-start me-2 action-edit" href="app-personnel-edit.php?<?php echo $url ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3">
                                                                <path d="M12 20h9"></path>
                                                                <path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z">
                                                                </path>
                                                            </svg></a>
                                                        <a class="badge badge-light-danger text-start action-delete" href="app-personnel.php?deletePersonnel=<?php echo $data['personnel_id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash">
    ...
    <script src="../src/assets/js/apps/personnel-list.js"></script>
</body>
