...
<head>
    ...
    <meta name="viewport" conteznt="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no">
    <title>Şube Duzenleme | Başar Emlak - Yönetim Paneli </title>
...
<body class="layout-boxed">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu active">
                        <a href="#branch" data-bs-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                        ...
                        <ul class="collapse submenu list-unstyled show" id="branch" data-bs-parent="#accordionExample">
                            <li>
                    ...
                    <div class="row invoice layout-top-spacing layout-spacing">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="doc-container">
                                <form action="app-branch-edit.php" method="POST">
                                    <div class="row">
                                        <div class="col-xl-12">
                                                ...
                                                <div class="invoice-detail-body">
                                                    ...
                                                    <div class="invoice-detail-title">
                                                        ...
                                                        <div class="invoice-title">
                                                            <input type="text" class="form-control" value="<?php echo $fetchDataBranchDetails['branch_name'] ?>" name="branch_name">
                                                        </div>

                                                        <div class="invoice-title">
                                                            <input type="text" class="form-control" value="<?php echo $fetchDataBranchDetails['branch_id'] ?>" name="branch_id" readonly>
                                                        </div>
                                                            ...
                                                            <div class="col-xl-12 invoice-address-company">
                                                                ...
                                                                <div class="invoice-address-company-fields">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="branch_owner" class="col-sm-3 col-form-label col-form-label-sm">Şube
                                                                            Sahibi</label>
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control form-control-sm" id="branch_owner" value="<?php echo $fetchDataBranchDetails['branch_owner'] ?>" name="branch_owner">
                                                                        </div>
                                                                    </div>

                                                                    <div class="form-group row">
                                                                        <label for="branch_email" class="col-sm-3 col-form-label col-form-label-sm">Şube
                                                                            Email</label>
                                                                        <div class="col-sm-9">
                                                                            <input type="email" class="form-control form-control-sm" id="branch_email" value="<?php echo $fetchDataBranchDetails['branch_email'] ?>" name="branch_email">
                                                                        </div>
                                                                    </div>

                                                                    <div class="form-group row">
                                                                        <label for="branch_address" class="col-sm-3 col-form-label col-form-label-sm">Adres</label>
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control form-control-sm" id="branch_address" value="<?php echo $fetchDataBranchDetails['branch_address'] ?>" name="branch_address">
                                                                        </div>
                                                                    </div>

                                                                    <div class="form-group row">
                                                                        <label for="branch_phone" class="col-sm-3 col-form-label col-form-label-sm">Telefon
                                                                            Numarasi</label>
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control form-control-sm" id="branch_phone" value="<?php echo $fetchDataBranchDetails['branch_phone'] ?>" name="branch_phone">
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div class="invoice-action-btn">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-12 col-md-4">
                                                            <button class="btn btn-success btn-download" type="submit" name="branch-update">Guncelle</button>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script src="../src/assets/js/apps/branch-edit.js"></script>
</body>
