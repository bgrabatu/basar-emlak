...
<head>
    ...
    <title>Personel Guncelleme | Başar Emlak - Yönetim Paneli </title>
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Personel Guncelleme</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" name="personnel_id" class="form-control mb-3" id="personnel_id" value="<?php echo $fetchDataPersonnelDetails['personnel_id'] ?>" readonly>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" name="personnel_name" class="form-control mb-3" id="personnel_name" value="<?php echo $fetchDataPersonnelDetails['personnel_name'] ?>">
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" name="personnel_surname" class="form-control mb-3" id="personnel_surname" value="<?php echo $fetchDataPersonnelDetails['personnel_surname'] ?>">
                                                                                    </div>
                                                                                </div>
                                                                                        ...
                                                                                        <select class="form-select mb-3" name="branch_id" id="branch_id">
                                                                                            ...
                                                                                            if (is_array($fetchDataBranch)) {
                                                                                                ...
                                                                                                foreach ($fetchDataBranch as $data) {
                                                                                                    $selected = ($data['branch_id'] == $fetchDataPersonnelDetails['branch_id']) ? 'selected' : '';
                                                                                            ?>
                                                                                                    <option value="<?php echo $data['branch_id']; ?>" <?php echo $selected; ?>><?php echo $data['branch_name']; ?></option>
                                                                                            <?php
                                                                                                    $sn++;
                                                                                                }
                                                                                            } else {
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <select class="form-select mb-3" name="personnel_job" id="personnel_job">
                                                                                            <option <?php echo ($fetchDataPersonnelDetails['personnel_job'] == 'Tum Meslekler') ? 'selected' : ''; ?>>Tum Meslekler</option>
                                                                                            <option <?php echo ($fetchDataPersonnelDetails['personnel_job'] == 'Emlak Danışmanı') ? 'selected' : ''; ?>>Emlak Danışmanı</option>
                                                                                            <option <?php echo ($fetchDataPersonnelDetails['personnel_job'] == 'Satış Temsilcisi') ? 'selected' : ''; ?>>Satış Temsilcisi</option>
                                                                                            <option <?php echo ($fetchDataPersonnelDetails['personnel_job'] == 'Kiralama Uzmanı') ? 'selected' : ''; ?>>Kiralama Uzmanı</option>
                                                                                            <option <?php echo ($fetchDataPersonnelDetails['personnel_job'] == 'Pazarlama Uzmanı') ? 'selected' : ''; ?>>Pazarlama Uzmanı</option>
                                                                                            <option <?php echo ($fetchDataPersonnelDetails['personnel_job'] == 'Gayrimenkul Değerleme Uzmanı') ? 'selected' : ''; ?>>Gayrimenkul Değerleme Uzmanı</option>
                                                                                            <option <?php echo ($fetchDataPersonnelDetails['personnel_job'] == 'Müşteri İlişkileri Sorumlusu') ? 'selected' : ''; ?>>Müşteri İlişkileri Sorumlusu</option>
                                                                                            <option <?php echo ($fetchDataPersonnelDetails['personnel_job'] == 'Finansal Danışman') ? 'selected' : ''; ?>>Finansal Danışman</option>
                                                                                            <option <?php echo ($fetchDataPersonnelDetails['personnel_job'] == 'Teknik Destek Uzmanı') ? 'selected' : ''; ?>>Teknik Destek Uzmanı</option>
                                                                                            <option <?php echo ($fetchDataPersonnelDetails['personnel_job'] == 'İş Geliştirme Uzmanı') ? 'selected' : ''; ?>>İş Geliştirme Uzmanı</option>
                                                                                            <option <?php echo ($fetchDataPersonnelDetails['personnel_job'] == 'Muhasebe ve Finans Sorumlusu') ? 'selected' : ''; ?>>Muhasebe ve Finans Sorumlusu</option>
                                                                                        </select>
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" name="personnel_gmail" class="form-control mb-3" id="personnel_gmail" value="<?php echo $fetchDataPersonnelDetails['personnel_gmail'] ?>">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label for="personnel_phone">Telefon Numarasi</label>
                                                                                        <input type="text" name="personnel_phone" class="form-control mb-3" id="personnel_phone" value="<?php echo $fetchDataPersonnelDetails['personnel_phone'] ?>">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="personnel_address">Adres</label>
                                                                                        <input type="text" name="personnel_address" class="form-control mb-3" id="personnel_address" value="<?php echo $fetchDataPersonnelDetails['personnel_address'] ?>">
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <select class="form-select mb-3" name="personnel_role" id="personnel_role">
                                                                                            <option <?php echo ($fetchDataPersonnelDetails['personnel_role'] == 'Tum Roller') ? 'selected' : ''; ?>>Tum Roller</option>
                                                                                            <option <?php echo ($fetchDataPersonnelDetails['personnel_role'] == 'Admin') ? 'selected' : ''; ?>>Admin</option>
                                                                                            <option <?php echo ($fetchDataPersonnelDetails['personnel_role'] == 'Personel') ? 'selected' : ''; ?>>Personel</option>
                                                                                        </select>
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" name="personnel_password" class="form-control mb-3" id="personnel_password" value="<?php echo $fetchDataPersonnelDetails['personnel_password'] ?>">
                                                                                    </div>
                                                                                </div>

                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label for="personnel_password_repeat">Sifre Onay</label>
                                                                                        <input type="text" name="personnel_password_repeat" class="form-control mb-3" id="personnel_password_repeat" value="<?php echo $fetchDataPersonnelDetails['personnel_password'] ?>">
                                                                                    </div>
                                                                                </div>

                                                                                <div class="col-md-12 mt-1">
                                                                                    <div class="form-group text-end">
                                                                                        <button class="btn btn-secondary" name="personnel-update">Kaydet</button>
                                                                                    </div>
                                                                                </div>
