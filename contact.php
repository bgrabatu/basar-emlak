...
<head>
    ...
    <!-- Title -->
    <title> İletişim | Başar Emlak</title>
    <!-- Favicon -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="breadcrumb__wrapper">
                        <h2 class="breadcrumb__title"> Bağlantı Kurun, Düşlerinizi İnşa Edelim!</h2>
        ...
        <div class="container container-two">
            <div class="section-heading">
                <span class="section-heading__subtitle bg-gray-100">
                    <span class="text-gradient fw-semibold">İletişim Bilgileri</span>
                </span>
                <h2 class="section-heading__title">Bize Ulaşın ve İletişimde Kalın!</h2>
            </div>
            <div class="row gy-4">
                <div class="col-lg-4 col-sm-6">
                    <div class="contact-card">
                        ...
                        <p class="contact-card__text font-18">
                            <a href="mailto:v" class="link">info@basaremlak.com</a>
                        </p>
                        <p class="contact-card__text font-18">
                            <a href="mailto:support@basaremlak.com" class="link">support@basaremlak.com</a>
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="contact-card">
                        ...
                        <p class="contact-card__text font-18">
                            Yavuz Selim Mahallesi, Eyübi Caddesi İstanbul/Sultanbeyli
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="contact-card">
                        ...
                        <h5 class="contact-card__title">Telefon Numarası </h5>
                        <p class="contact-card__text font-18">
                            <a href="tel:05398386310" class="link"> 0539 838 6310</a>
                        </p>
                        <p class="contact-card__text font-18">
                            <a href="tel:05398386311" class="link"> 0539 838 6311</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section class="contact-us-section padding-b-120">
        <div class="container container-two">
            <div class="contact-form bg-white">
                <div class="section-heading">
                    <span class="section-heading__subtitle bg-gray-100">
                        <span class="text-gradient fw-semibold">İletişim Kurun</span>
                    </span>
                    <h2 class="section-heading__title"> Hayallerinizin İnşasına Birlikte Başlayalım! </h2>
                    <p class="section-heading__desc">Sorularınızı, fikirlerinizi veya taleplerinizi bizimle paylaşın. Size yardımcı olmak ve hayallerinizin evini bulmanızı sağlamak için buradayız.</p>
                </div>
                <form action="#" class="contact-form__form">
                    <div class="row gy-4">
                        <div class="col-sm-6 col-xs-6">
                            <input type="text" class="common-input" placeholder="İsim">
                        </div>
                        <div class="col-sm-6 col-xs-6">
                            <input type="email" class="common-input" placeholder="Email">
                        </div>
                        <div class="col-sm-6 col-xs-6">
                            <input type="tel" class="common-input" placeholder="Telefon Numarası">
                        </div>
                        <div class="col-sm-6 col-xs-6">
                            <input type="text" class="common-input" placeholder="Konu">
                        </div>
                        <div class="col-12">
                            <textarea class="common-input" placeholder="Mesaj"></textarea>
                        </div>
                        <div class="col-12">
                            <button type="submit" class="btn btn-main w-100">Gönder!</button>
                        </div>
                    </div>
                </form>
            </div>
