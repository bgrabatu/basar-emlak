...
<head>
    ...
    <!-- Title -->
    <title>Başar Emlak Şubeleri - Size Daha Yakınız! | Başar Emlak</title>
    <!-- Favicon -->
...
<body>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="breadcrumb__wrapper">
                        <h2 class="breadcrumb__title"> Başar Emlak Ailesinin Şubeleri: Size Daha Yakınız!</h2>
                        <ul class="breadcrumb__list">
                            ...
                            <li class="breadcrumb__item"> <span class="breadcrumb__item-text"> Şubelerimiz </span> </li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="map-location padding-y-120">
        <div class="container container-two">
            <div class="row gy-4">
                <div class="col-lg-8">

                    <div class="map-location__content">
                        <div class="map-location__item mb-5">
                            <h3 class="title text-poppins mb-3 fw-semibold">Başar Emlak </h3>
                            <div class="row gy-4">
                                <?php
                                if (is_array($fetchDataBranches)) {
                                    $sn = 1;
                                    foreach ($fetchDataBranches as $data) {
                                ?>
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="card common-card">
                                                <div class="card-body p-lg-4 p-3">
                                                    <h6 class="mb-4 border-bottom pb-3 mb-3 font-18"><?php echo $data['branch_name'] ?></h6>
                                                    <div class="contact-info style-two d-flex align-items-center gap-lg-3 gap-2">
                                                        <span class="contact-info__icon flex-shrink-0"><i class="fas fa-map-marker-alt"></i></span>
                                                        <div class="contact-info__content">
                                                            <span class="contact-info__text text-heading fw-bold font-16">Adres</span>
                                                            <span class="contact-info__address font-15 fw-500"><?php echo $data['branch_address'] ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="contact-info style-two d-flex align-items-center gap-lg-3 gap-2">
                                                        <span class="contact-info__icon flex-shrink-0"><i class="fas fa-phone"></i></span>
                                                        <div class="contact-info__content">
                                                            <span class="contact-info__text text-heading fw-bold font-16">Telefon Numarası</span>
                                                            <span class="contact-info__address font-15 fw-500"><?php echo $data['branch_phone'] ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="contact-info style-two d-flex align-items-center gap-lg-3 gap-2">
                                                        <span class="contact-info__icon flex-shrink-0"><i class="fas fa-envelope"></i></span>
                                                        <div class="contact-info__content">
                                                            <span class="contact-info__text text-heading fw-bold font-16">Email</span>
                                                            <span class="contact-info__address font-15 fw-500"><?php echo $data['branch_email'] ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="d-flex mt-4 align-items-center gap-2">
                                                        <a href="#" class="btn btn-outline-light btn-sm w-50">Harita
                                                            <span class="icon-right text-gradient icon">
                                                                <i class="fas fa-paper-plane"></i>
                                                            </span>
                                                        </a>
                                                        <a href="tel:<?php echo cleanPhoneNumber($data['branch_phone']) ?>" class="btn btn-outline-light btn-sm w-50">Ara!
                                                            <span class="icon-right text-gradient icon">
                ...
                <div class="col-lg-4">
                    <div class="google-map position-sticky top-120">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d48201.56586278654!2d29.237115081913174!3d40.968387526335654!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cad05ff4c5d567%3A0xb011010aa2dc68c0!2sSultanbeyli%2C%20%C4%B0stanbul!5e0!3m2!1str!2str!4v1715445867234!5m2!1str!2str" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </div>
        </div>
