...
<head>
    ...
    <!-- Title -->
    <title> <?php echo $fetchDataBlogDetailsPage['blog_post_title'] ?> | Başar Emlak</title>
    <!-- Favicon -->
...
<body>
    ...
    <div class="blog-details-section padding-y-120">
        <div class="container container-two">
            <div class="row gy-4">
                <div class="col-lg-8">
                    <div class="blog-details">
                        <div class="blog-details__thumb">
                            <img src="admin/<?php echo $fetchDataBlogPhotosDetailsPage['blog_850x546'] ?>" alt="">
                            <span class="blog-details__date"><?php echo $fetchDataBlogDetailsPage['blog_date'] ?></span>
                        </div>
                        <div class="blog-details__content">
                            <ul class="blog-infos">
                                <li class="blog-infos__item">
                                    <?php echo $fetchDataBlogDetailsPage['personnel_name'] ?>
                                </li>
                                <li class="blog-infos__item">
                                    <a href="#" class="blog-infos__link">
                                        <span class="icon"><i class="fas fa-comment-alt"></i> </span>
                                        <?php echo $fetchDataBlogDetailsPage['blog_post_category'] ?>
                                    </a>
                                </li>
                                <li class="blog-infos__item">
                                    <a href="#" class="blog-infos__link">
                            ...
                            <h5 class="blog-details__title"><?php echo $fetchDataBlogDetailsPage['blog_content_first_title'] ?></h5>
                            <p class="blog-details__desc"><?php echo $fetchDataBlogDetailsPage['blog_content_first_description'] ?></p>
                        </div>

                        <!-- Blog Testi Start -->
                        <div class="blog-testi">
                            <p class="blog-testi__desc"><?php echo $fetchDataBlogDetailsPage['blog_quote'] ?> </p>
                            <div class="blog-testi__bottom flx-between">
                                <span class="blog-testi__name text-gradient"><?php echo $fetchDataBlogDetailsPage['blog_quote_owner'] ?></span>
                                <img src="assets/images/icons/quote-two.svg" alt="" class="blog-testi__quote">
                            </div>
                        </div>
                        <!-- Blog Testi End -->
                        ...
                        <div class="blog-showcase">
                            <h5 class="blog-showcase__title"><?php echo $fetchDataBlogDetailsPage['blog_content_second_title'] ?></h5>
                            <p class="blog-showcase__desc"><?php echo $fetchDataBlogDetailsPage['blog_content_second_description'] ?> </p>
                            <div class="blog-showcase__content flx-align gap-4">
                                <div class="blog-showcase__thumb">
                                    <img src="admin/<?php echo $fetchDataBlogPhotosDetailsPage['blog_300x213'] ?>" alt="">
                                </div>
                                <ul class="check-list">
                                    <li class="check-list__item d-flex align-items-center">
                                        <span class="icon"><i class="fas fa-check"></i></span>
                                        <span class="text"><?php echo $fetchDataBlogDetailsPage['blog_content_items_1'] ?></span>
                                    </li>
                                    <li class="check-list__item d-flex align-items-center">
                                        <span class="icon"><i class="fas fa-check"></i></span>
                                        <span class="text"><?php echo $fetchDataBlogDetailsPage['blog_content_items_2'] ?></span>
                                    </li>
                                    <li class="check-list__item d-flex align-items-center">
                                        <span class="icon"><i class="fas fa-check"></i></span>
                                        <span class="text"><?php echo $fetchDataBlogDetailsPage['blog_content_items_3'] ?></span>
                                    </li>
                                    <li class="check-list__item d-flex align-items-center">
                                        <span class="icon"><i class="fas fa-check"></i></span>
                                        <span class="text"><?php echo $fetchDataBlogDetailsPage['blog_content_items_4'] ?></span>
                                    </li>
                                </ul>
                            </div>
                            <p class="blog-showcase__desc"><?php echo $fetchDataBlogDetailsPage['blog_content_third_description'] ?></p>
                        </div>
                        <!-- Blog ShowCase End -->

                        <!-- Blog Keyword Start -->
                        <div class="blog-keyword flx-between gap-2">
                            <div class="blog-keyword__content">
                                <span class="blog-keyword__text t text-heading fw-bold">Anahtar Kelime: </span>
                                <?php
                                $keywords = splitByComma($fetchDataBlogDetailsPage['blog_keywords']);
                                foreach ($keywords as $keyword) {
                                    echo '<a href="#" class="blog-keyword__link">' . $keyword . '</a>';
                                }
                                ?>
                            </div>
                            <ul class="social-list style-two mt-0">
                                <li class="social-list__item">
                                    <a href="https://www.facebook.com" class="social-list__link flx-center text-facebook"><i class="fab fa-facebook"></i>
                                    </a>
                                </li>
                                <li class="social-list__item">
                                    <a href="https://www.pinterest.com" class="social-list__link flx-center text-pinterest"><i class="fab fa-pinterest"></i>
                                    </a>
                                </li>
                                <li class="social-list__item">
                                    <a href="https://www.linkedin.com" class="social-list__link flx-center text-linkedin"> <i class="fab fa-linkedin"></i>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="col-lg-12 pt-5">
                            <h5 class="comment-title mb-4 mb-lg-5">Yorumlar</h5>
                            <ul class="comment-list">
                                <?php
                                if (is_array($fetchDataBlogDetailsComment)) {
                                    $sn = 1;
                                    foreach ($fetchDataBlogDetailsComment as $data) {
                                ?>
                                        <li class="comment-list__item d-flex">
                                            <div class="comment-list__content">
                                                <div class="flx-align gap-2 gap-sm-4">
                                                    <h6 class="comment-list__name font-16"><?php echo $data['comment_name'] ?></h6>
                                                    <span class="comment-list__date"><?php echo $data['comment_date_time'] ?></span>
                                                </div>
                                                <p class="comment-list__desc"><?php echo $data['comment'] ?></p>
                                            </div>
                                        </li>
                                <?php
                                        $sn++;
                                    ...
                                    echo $fetchDataBlogDetailsComment;
                                } ?>
                            </ul>
                        </div>
                        <!-- Comment End -->
                        ...
                        <!-- Form Start -->
                        <?php if ($fetchDataBlogDetailsPage['blog_comment_status'] == 1) : ?>
                            <div class="comment-form" id="comment-box">
                                <h5 class="comment-form__title"> Fikirlerinizi Paylaşın </h5>
                                <p class="comment-form__desc"> Görüşlerinizi ve düşüncelerinizi bizimle paylaşın! Sizin yorumlarınızı duymak bizim için önemlidir ve paylaştığınız her geri bildirim, blogumuzu daha iyiye taşımamıza yardımcı olur. </p>
                                <form action="blog-details.php" method="POST">
                                    <div class="row gy-4">
                                        <input type="hidden" name="blog_id" value="<?php echo $fetchDataBlogDetailsPage['blog_id'] ?>" readonly>
                                        <div class="col-sm-6">
                                            <input type="text" class="common-input common-input--grayBg" name="comment_name" placeholder="İsim">
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="email" class="common-input common-input--grayBg" name="comment_email" placeholder="Email">
                                        </div>
                                        <div class="col-sm-12">
                                            <textarea class="common-input common-input--grayBg" name="comment" placeholder="Yorum"></textarea>
                                        </div>
                                        <div class="col-sm-12">
                                            <button class="btn btn-main w-100" type="submit" name="comment-add"> Gönder! </button>
                                        </div>
                                    </div>
                                </form>
                            </div>
